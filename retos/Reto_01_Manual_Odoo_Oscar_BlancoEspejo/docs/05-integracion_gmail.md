...
Una vez conectaedo podemos ver información de la empresa o contactos que nos hayan enviado un correo, asi como crear nuevos contactos u oportunidades directamente desde el correo.
...
Finalmente en ajustes generales activamos utilizar servidores de correo electrónico personalizados
y se muestra la opcion de usar un servidor de correo de Gmail en el cual proporcionamos el ID y el secreto del cliente.
