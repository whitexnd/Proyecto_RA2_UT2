...
![Módulo Proyectos](../assets/img/08-proyectos/paso08_modulo-proyectos.png "Módulo Proyectos")


Una vez creado podremos establecer las etapas del proyecto
![Etapas del Proyecto](../assets/img/08-proyectos/paso08_etapas-proyecto.png "Etapas del Proyecto")

Dentro de cada etapa podremos crear tareas y asignarlas, y posteriormente editarlas
![Tareas del Proyecto](../assets/img/08-proyectos/paso08_tareas-proyecto.png "Tareas del Proyecto")
...
![Subtareas de la Tarea](../assets/img/08-proyectos/paso08_subtareas-tarea.png "Subtareas de la Tarea")
...
![Tipos de Vistas](../assets/img/08-proyectos/paso08_vistas-tipos.png "Tipos de Vistas")

### Tareas Recurrentes
Al clickar en nuestro proyecto en la seccion de ajustes veremos la opcion de tareas recurrentes la cual habilitaremos
![Tareas Recurrentes](../assets/img/08-proyectos/paso08_tareas-recurrentes.png "Tareas Recurrentes")

Al hacer esto podemos editar las tareas y nos saldra la opcción de hacerla recurrente
![Configurar Tarea Recurrente](../assets/img/08-proyectos/paso08_configurar-recurrente.png "Configurar Tarea Recurrente")
...
![Tareas Dependientes](../assets/img/08-proyectos/paso08_tarea-dependiente.png "Tareas Dependientes")
...
![Hitos del Proyecto](../assets/img/08-proyectos/paso08_hitos-proyecto.png "Hitos del Proyecto")
